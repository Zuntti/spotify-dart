...
Future main() async {
  ...
  group('Search', () {
    test('get', () async {
      List<Page<Object>> searchResult = await spotify.search!.get('metallica').first();
  ...
  group('User', () {
    ...
    test('recentlyPlayed', () async {
      ...
      var result =
          await (spotify.me!.recentlyPlayed(limit: 3, before: DateTime.now()) as FutureOr<Iterable<PlayHistory>>);
